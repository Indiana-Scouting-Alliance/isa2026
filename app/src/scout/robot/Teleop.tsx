  ...
  return (
    <div className={`${scoutStyles.contentContainer} ${teleopStyles.contentColumn}`}>
      <div
        ...
        {/* Left: Field image with scoring locations */}
        ...
        {/* Right: Active + Inactive controls */}
        <div className={`${scoutStyles.half}`}>
          {/* Active controls */}
          <label className={`${scoutStyles.label} ${teleopStyles.phaseLabel} ${teleopStyles.activePhasLabel}`}>Active Phase</label>
          ...
          <label className={`${scoutStyles.label} ${teleopStyles.phaseLabel} ${teleopStyles.inactivePhasLabel}`}>Inactive phase</label>
